...
CREATE TABLE `tl_module` (
  ...
  `socialshareprivacy_uri` blob NULL,
  ...
  `socialshareprivacy_facebook_action` varchar(10) NOT NULL default 'recommend',
  ...
  `socialshareprivacy_twitter_language` char(2) NOT NULL default '',
